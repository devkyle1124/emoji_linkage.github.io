...
.set(game, {
    ...
    transform: 'translate(-50%, -50%)'
		...
		.set('.btn',		  {width:90, height:90, borderRadius:'50%', border:'3px solid transparent', textAlign:'center', fontSize:72, lineHeight:'86px'})
		.set(hintBtn,		  {right:60, bottom:30, width:75, fontSize:25, textAlign:'center', autoAlpha:0})
		.set('.foundTxt',	{left:0, top:30, width:1024, fontSize:40, textAlign:'center', textContent:'Find the matching pair...', fontWeight:400, letterSpacing:0.25})
		.set('.timeTxt',	{left:180, top:20, fontSize:50})
...
function updateTime(){
		if (timeLeft>0){
			...
			TweenMax.set('.endTxt', {textContent:hint+" Try again? "+hint, fontSize:35, fontWeight:400});
